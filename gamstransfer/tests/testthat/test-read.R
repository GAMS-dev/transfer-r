...
atol = c(1, 2)
names(atol) = c("blah1", "blah2")
expect_error(v1$equals(v2, checkMetaData=FALSE, atol= atol))

rtol = c(1, 2)
names(rtol) = c("blah1", "blah2")
expect_error(v1$equals(v2, checkMetaData=FALSE, rtol= rtol))
...
expect_true(v0$equals(v0p, checkMetaData=FALSE, atol=c(level=0.1)))
expect_true(v0$equals(v0p, checkMetaData=FALSE, atol=0.1))
expect_true(v0$equals(v0p,checkMetaData=FALSE, atol=c(level=0.1, marginal=0)))
expect_false(v0$equals(v0p, checkMetaData=FALSE, atol=c(level=0, marginal=0.1)))
...
expect_true(v1$equals(v1p, checkMetaData=FALSE, atol=c(level=0.1)))
expect_true(v1$equals(v1p, checkMetaData=FALSE, atol=0.1))
expect_true(v1$equals(v1p, checkMetaData=FALSE, atol=c(level=0.1, marginal=0)))
expect_false(v1$equals(v1p, checkMetaData=FALSE, atol=c(level=0, marginal=0.1)))
